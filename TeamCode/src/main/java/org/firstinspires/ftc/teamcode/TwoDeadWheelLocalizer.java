...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -4760.7775; //-4742.0125; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -10473.7105; //-429.44825; // x position of the perpendicular encoder (in tick units)
    }
