...
//    private Servo intakeServo = null; // Example for an intake/indexing servo
    ...
    public void runOpMode() throws InterruptedException{
        ...
        final double COUNTS_PER_MOTOR_REV = 537.6; // GoBilda 5202 series motor
        final double DRIVE_GEAR_REDUCTION = 1.0; // This is a 1:1 gear ratio (adjust if needed)
        final double WHEEL_DIAMETER_INCHES = 4.0; // Your wheel diameter
        final double COUNTS_PER_INCH = (COUNTS_PER_MOTOR_REV * DRIVE_GEAR_REDUCTION) / (WHEEL_DIAMETER_INCHES * 3.1415);
        final double DRIVE_SPEED = 0.5;
        final double SHOOT_POWER = 0.8;
        final long SHOOT_TIME_MS = 2000; // Time the shooter runs (adjust as needed)
        ...
        //old code that used motor power instead of odom
